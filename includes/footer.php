    ...
    <div class="main">
        ...
        <div class="office row">
            ...
            <div class="office-des">
                <p>
                    Andheri Gali <br>
                    Gokuldham Society - Chennai East Uttar Pradesh <br>pin - 100002<br></p>

                <a href="#">E-commerce@saman.com</a>

                <p class="num">+919293949596</p>
            </div>
        </div>
        ...
        <div class="link row">
            ...
            <div class="link-des">
                ...
                <a href="index.php" class="footer-links">About</a>
                <a href="view-all-products.php" class="footer-links">Products</a>
                <a href="index.php" class="footer-links">Contact</a>
            </div>
        </div>
